    ...
    <>
      <div className="mx-auto w-full min-w-0">
        ...
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            <span
              data-br=":r0:"
              data-brr="1"
              className="display: inline-block; vertical-align: top; text-decoration: inherit; max-width: 391px;"
            >
        ...
        <div className="pb-12 pt-8">
          <div className="mdx">
            <div className="group relative my-4 flex flex-col space-y-2 [&amp;_.preview>[data-orientation=vertical]]:sm:max-w-[70%]">
              <div
                dir="ltr"
              ...
              >
                <div className="flex items-center justify-between pb-3">
                  <div
                    ...
                    className="inline-flex h-9 items-center text-muted-foreground w-full justify-start r border-b bg-transparent p-0 rounded-lg"
                    data-orientation="horizontal"
                  >
                    <button
                      type="button"
                      role="tab"
                      aria-selected="true"
                      aria-controls="radix-:r1:-content-preview"
                      data-state="active"
                      id="radix-:r1:-trigger-preview"
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:r1:-content-code"
                      data-state="inactive"
                      id="radix-:r1:-trigger-code"
                      className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    >
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r1:-trigger-preview"
                  id="radix-:r1:-content-preview"
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r1:-trigger-code"
                  id="radix-:r1:-content-code"
            ...
            >
              ...
              >
                <button
                  ...
                  role="tab"
                  aria-selected="true"
                  aria-controls="radix-:r5:-content-cli"
                  data-state="active"
                  id="radix-:r5:-trigger-cli"
                  className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                >
                ...
                <button
                  ...
                  role="tab"
                  aria-selected="false"
                  aria-controls="radix-:r5:-content-manual"
                  data-state="inactive"
                  id="radix-:r5:-trigger-manual"
                  className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                >
              ...
              <div
                ...
                data-orientation="horizontal"
                role="tabpanel"
                aria-labelledby="radix-:r5:-trigger-cli"
                id="radix-:r5:-content-cli"
                    ...
                    >
                      ...
                      >
                        <span className="line">
                          ...
                          <span className="color: rgba(255, 255, 255, 0.533); font-weight: bold;"></span>
              ...
              <div
                ...
                data-orientation="horizontal"
                role="tabpanel"
                aria-labelledby="radix-:r5:-trigger-manual"
                id="radix-:r5:-content-manual"
                className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative [&amp;_h3.font-heading]:text-base [&amp;_h3.font-heading]:font-semibold"
              ></div>
            </div>
            <h2
