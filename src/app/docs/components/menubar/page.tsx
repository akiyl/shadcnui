      ...
      <div className="mx-auto w-full min-w-0">
        ...
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            <span
              data-br=":Ridttbq6la:"
              data-brr="1"
              className="display: inline-block; vertical-align: top; text-decoration: inherit; max-width: 506px;"
            >
        ...
        <div className="flex items-center space-x-2 pt-4">
          ...
          <a
            ...
            rel="noreferrer"
            className="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 gap-1"
            href="https://www.radix-ui.com/docs/primitives/components/menubar#api-reference"
          >
            API Reference
            <svg
              width="15"
                ...
                >
                  ...
                  <div className="theme-zinc w-full rounded-lg">
                    <div className="preview flex min-h-[350px] w-full justify-center p-10 items-center">
                      <div
                        role="menubar"
                        className="flex h-9 items-center outline-none space-x-1 rounded-md border bg-background p-1 shadow-sm"
                        data-orientation="horizontal"
                      >
                        <button
                          type="button"
            ...
            <div data-rehype-pretty-code-fragment="">
              ...
              >
                ...
                >
                  ...
                  <span className="line">
                    <span className="color: rgb(255, 255, 255);"> Menubar</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      ,
                    </span>
                  </span>
              ...
              >
                ...
                >
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">File</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">⌘T</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">Share</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">Print</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">
