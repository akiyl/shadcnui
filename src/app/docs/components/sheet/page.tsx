    ...
    <>
      <div className="mx-auto w-full min-w-0">
        <div className="mb-4 flex items-center space-x-1 text-sm text-muted-foreground">
          ...
          <div className="font-medium text-foreground">Sheet</div>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            <span
              data-br=":r5k:"
              data-brr="1"
              className="display: inline-block; vertical-align: top; text-decoration: inherit; max-width: 418px;"
            >
              Extends the Dialog component to display content that complements
        ...
        <div className="pb-12 pt-8">
          <div className="mdx">
            <div className="group relative my-4 flex flex-col space-y-2">
              ...
              >
                <div className="flex items-center justify-between pb-3">
                  ...
                  >
                    <button
                      ...
                      role="tab"
                      aria-selected="true"
                      aria-controls="radix-:r5l:-content-preview"
                      data-state="active"
                      id="radix-:r5l:-trigger-preview"
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:r5l:-content-code"
                      data-state="inactive"
                      id="radix-:r5l:-trigger-code"
                      className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    >
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r5l:-trigger-preview"
                  id="radix-:r5l:-content-preview"
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r5l:-trigger-code"
                  id="radix-:r5l:-content-code"
            ...
            >
              ...
              >
                <button
                  ...
                  role="tab"
                  aria-selected="true"
                  aria-controls="radix-:r5p:-content-cli"
                  data-state="active"
                  id="radix-:r5p:-trigger-cli"
                  className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                >
                ...
                <button
                  ...
                  role="tab"
                  aria-selected="false"
                  aria-controls="radix-:r5p:-content-manual"
                  data-state="inactive"
                  id="radix-:r5p:-trigger-manual"
                  className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                  data-orientation="horizontal"
                  data-radix-collection-item=""
                >
              ...
              <div
                ...
                data-orientation="horizontal"
                role="tabpanel"
                aria-labelledby="radix-:r5p:-trigger-cli"
                id="radix-:r5p:-content-cli"
              ...
              <div
                ...
                data-orientation="horizontal"
                role="tabpanel"
                aria-labelledby="radix-:r5p:-trigger-manual"
                id="radix-:r5p:-content-manual"
                className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative [&amp;_h3.font-heading]:text-base [&amp;_h3.font-heading]:font-semibold"
              ></div>
            </div>
            <h3
            ...
            <p className="leading-7 [&amp;:not(:first-child)]:mt-6">
              ...
              to indicate the edge of the screen where the component will
              appear. The values can be{" "}
              <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm">
                top
              </code>
              ,{" "}
            ...
            <div className="group relative my-4 flex flex-col space-y-2">
              ...
              >
                <div className="flex items-center justify-between pb-3">
                  ...
                  >
                    <button
                      ...
                      role="tab"
                      aria-selected="true"
                      aria-controls="radix-:r5u:-content-preview"
                      data-state="active"
                      id="radix-:r5u:-trigger-preview"
                      className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    >
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:r5u:-content-code"
                      data-state="inactive"
                      id="radix-:r5u:-trigger-code"
                      className="inline-flex items-center justify-center whitespace-nowrap py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background relative h-9 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:shadow-none"
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    >
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r5u:-trigger-preview"
                  id="radix-:r5u:-content-preview"
                  className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative rounded-md border"
                >
                  <div className="flex items-center justify-between p-4">
                    <button
                ...
                <div
                  ...
                  data-orientation="horizontal"
                  role="tabpanel"
                  aria-labelledby="radix-:r5u:-trigger-code"
                  id="radix-:r5u:-content-code"
                  className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                ></div>
              </div>
            </div>
            ...
            <p className="leading-7 [&amp;:not(:first-child)]:mt-6">
              You can adjust the size of the sheet using CSS classNamees:
            </p>
            <div data-rehype-pretty-code-fragment="">
              <pre
                className="mb-4 mt-6 max-h-[650px] overflow-x-auto rounded-lg border bg-zinc-950 py-4 dark:bg-zinc-900"
