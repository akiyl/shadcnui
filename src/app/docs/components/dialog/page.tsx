    ...
    <>
      <div className="mx-auto w-full min-w-0">
        <div className="mb-4 flex items-center space-x-1 text-sm text-muted-foreground">
          ...
          <div className="font-medium text-foreground">Dialog</div>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            <span
              data-br=":Ridttbq6la:"
              data-brr="1"
              className="display: inline-block; vertical-align: top; text-decoration: inherit; max-width: 492px;"
            >
        ...
        <div className="pb-12 pt-8">
          <div className="mdx">
            ...
            <div data-rehype-pretty-code-fragment="">
              ...
              >
                ...
                >
                  ...
                  <span className="line">
                    <span className="color: rgb(255, 255, 255);"> Dialog</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      ,
                    </span>
                  </span>
            ...
            <p className="leading-7 [&amp;:not(:first-child)]:mt-6">
              ...
              component. For more information, refer to the linked issue{" "}
              <a
                className="font-medium underline underline-offset-4"
                href="https://github.com/radix-ui/primitives/issues/1836"
              >
                here
              </a>
              .
              ...
              >
                ...
                >
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">Download</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">
                  ...
                  <span className="line">
                    ...
                    <span className="color: rgb(255, 255, 255);">Delete</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
                    <span className="color: rgb(255, 255, 255);">span</span>
                  ...
                  <span className="line line--highlighted">
                    ...
                    <span className="color: rgb(255, 255, 255);">Confirm</span>
                    <span className="color: rgba(255, 255, 255, 0.533);">
                      &lt;/
                    </span>
